...
## MCP 工具
`list_projects(分页), create_project, create_epic, create_story, create_task, get_task, update_task, set_task_spec, get_task_spec, set_status, search_tasks(分页), spec_proposal, generate_tasks_from_spec, get_epic, update_epic, delete_epic, get_story, update_story, delete_story`
