...
## PowerShell `Set-Content -Encoding UTF8` �ƻ����� Unicode �ַ���2026-08-21��

**���� �� Windows PowerShell 5.1 �ϱ༭�� `?`��U+203A��/ `��` / `?` ������ Unicode �ַ���Դ�ļ�ʱ��**����** `Set-Content -Encoding UTF8` �� `[System.IO.File]::WriteAllText`������ Python��`open(p, 'wb')` + ��ʽ UTF-8 + BOM���� `git checkout -- <file>` �ָ���**

- **֤��/ԭ��**��
  - PS 5.1 `Set-Content -Encoding UTF8` ʵ��д���� **UTF-8 with BOM ����д BOM**��PS 5.1 ����Ϊ������ ASCII �ַ����������������� `?`��U+203A SINGLE RIGHT-POINTING ANGLE QUOTATION MARK������**�������ַ�**��д���� mojibake `�?` ֮��
  - ͬ�� `[System.IO.File]::WriteAllText($content, [System.Text.Encoding]::UTF8)` Ҳ�����𻵣�ȡ���� PS �汾�� .NET Framework �汾��
  - ���֣�app.html ��� `<span class="qv-sep">?</span>` ���ĳ� `<span class="qv-sep">�?/span>`��Angular ���뱨 NG5002: Unexpected character "EOF" / Unclosed block "if"���������󣬴� line 0:0 ����
  - **����**��PS 5.1 + Windows Ĭ�� ANSI ����ҳ��GBK/CP936���£�PS ���ַ����� ANSI ��������ת UTF-8 ʱ�𻵶��ֽ��ַ�
- **�޷�**��
  1. **���� PowerShell �ĺ������ַ����ļ�**������ Python��
     ```python
     import io
     ...
     ```
  2. �� `git checkout HEAD -- <file>` �ָ���**ֻ��Ҫ�ĵ��ֽڸ����� Python ��**������ȫ�ļ������𻵣�
  3. �� PS 6+/PS Core��`pwsh` ������ `powershell`����`Set-Content -Encoding utf8` ��Ϊ��ȷ
- **���ű�**���绳���ļ��� mojibake����
  ```python
  ...
  ```
- **���ó���**��
  - Windows PowerShell 5.1 (Ĭ�� powershell.exe) �༭ UTF-8 Դ�ļ��� Angular/Rollup/esbuild ���뱨 NG5002
  - minified �ļ��ﺬ CJK + ������ŵĻ������
  - git diff ��ʾ���� `�?/button>` / `�?/span>` ���滻
- **�����¼�**��2026-08-21 �ع� app.html line 30 ʱ�� `[System.IO.File]::WriteAllText` ���ļ������� app.html �� 17 �� `?` �ַ����ƻ��� `�?`��Angular ���뱨 NG5002���޷���git checkout HEAD �ָ� + Python (open 'wb') �� line 30���� commit 5b3a2cb �޸���
