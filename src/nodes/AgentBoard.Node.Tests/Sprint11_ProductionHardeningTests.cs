...
public sealed class Sprint11_ProductionHardeningTests
{
    ...
    private sealed class ThrowingProcessExecutor : AgentBoard.Node.Process.IProcessExecutor
    {
        public Task<AgentBoard.Node.Process.ProcessResult> ExecuteAsync(
            AgentBoard.Node.Process.ProcessSpec spec, CancellationToken ct) =>
