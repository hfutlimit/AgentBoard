...
```powershell
dotnet publish src\nodes\AgentBoard.Node -c Release -r win-x64 --self-contained false -o C:\AgentBoard\ProposalWorker
sc.exe create "AgentBoard Proposal Worker" binPath= "C:\AgentBoard\ProposalWorker\AgentBoard.Node.exe" start= auto
