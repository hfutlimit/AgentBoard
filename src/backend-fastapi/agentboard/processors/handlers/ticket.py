...
from ..config import ACTION_TICKET_CREATED, AgentDecision, ProcessorInvoker
from ..contract import ExecutionCommand, ExecutionResult, ExecutionStatus, WorkType
from .base import BaseWorkHandler

log = logging.getLogger("agentboard.processors.ticket")
...
class TicketHandler(BaseWorkHandler):
    ...
    def handle(self, request: dict, invoker: ProcessorInvoker) -> str:
